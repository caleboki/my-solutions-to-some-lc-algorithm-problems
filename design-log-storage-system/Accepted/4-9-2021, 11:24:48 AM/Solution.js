...
class LogSystem {
    ...
    retrieve(start, end, granularity) {
        ...
        //Numbers in filter indicate where to cut off the start the startTime and endTime   
        //string, because string has the format: Year:Month:Day:Hour:Minute:Second, for 
        //example, 2017:01:01:23:59:59
