...
class WordDictionary {
    ...
    addWord(word) {
        ...
        // after looping, the currentNode variable will point to the node representing the last         //letter of word. so we mark that node as a word ending.
    ...
    search(word) {
        const searchHelper = (currentNode, i) => {
            ...
            if (char === '.') {
                ...
                for (let j in currentNode.children) {
